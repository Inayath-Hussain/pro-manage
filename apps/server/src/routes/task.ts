...
import { getAnalyticsController } from "../controllers/tasks/analytics";
...
router.get("/analytics", tryCatchWrapper(authMiddleware))       // middleware
router.get("/analytics", tryCatchWrapper(getAnalyticsController))       // controller
