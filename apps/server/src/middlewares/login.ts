...
export const validateLoginBody: IValidateRequestMiddlewares = [
    ...
    body("password").trim().escape()
        ...
        .isStrongPassword({ minLength: 8, minLowercase: 1, minUppercase: 1, minNumbers: 1, minSymbols: 1 }).withMessage("password should be 8 letters long and contain atleast one number, one Uppercase letter and one special symbol"),
